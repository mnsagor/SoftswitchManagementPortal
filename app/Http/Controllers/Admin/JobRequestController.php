...
class JobRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = JobRequest::with(['network_type', 'job_type', 'request_type', 'request_status', 'requested_by', 'verified_by', 'approved_by', 'rejected_by'])->select(sprintf('%s.*', (new JobRequest)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'network_type', 'job_type', 'request_type', 'request_status', 'requested_by', 'verified_by', 'approved_by', 'rejected_by']);
        ...
        return view('admin.jobRequests.index', compact('network_types', 'job_types', 'request_types', 'job_request_statuses', 'users', 'users', 'users', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.jobRequests.create', compact('network_types', 'job_types', 'request_types', 'request_statuses', 'requested_bies', 'verified_bies', 'approved_bies', 'rejected_bies'));
    }
    ...
    public function edit(JobRequest $jobRequest)
    {
        ...
        $jobRequest->load('network_type', 'job_type', 'request_type', 'request_status', 'requested_by', 'verified_by', 'approved_by', 'rejected_by');

        return view('admin.jobRequests.edit', compact('network_types', 'job_types', 'request_types', 'request_statuses', 'requested_bies', 'verified_bies', 'approved_bies', 'rejected_bies', 'jobRequest'));
    }
