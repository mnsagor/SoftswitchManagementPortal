...
class UsersController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.users.index', compact('users', 'roles', 'emplpyees'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('roles', 'employees'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('roles', 'employees', 'user'));
    }
