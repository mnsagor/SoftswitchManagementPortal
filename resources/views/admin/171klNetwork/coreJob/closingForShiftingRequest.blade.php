...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ "Closing for Shifting Request" }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.171klnetwork.corejob.store-closing-for-shifting.request") }}" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" id="request_type" name="request_type" value="{{ config('global.CLOSING_FOR_SHIFTING_REQUEST') }}">
                <div class="form-group">
