...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.171klnetwork.corejob.store-number-change.request") }}" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" id="request_type" name="request_type" value="{{ config('global.NUMBER_CHANGE_REQUEST') }}">
                <div class="form-group">
