                    ...
                    <div class="panel-body">
                        <div style="margin-bottom: 10px; margin-top: 10px" class="row">
                            <div class="col-lg-12">
                                ...
                                @include('admin.171klNetwork.csvImport.restorationModal', ['model' => 'JobRequest',
                                'route' => 'admin.job-requests.parseCsvImport.171kl-coreJob'])

                            </div>
                        </div>
                        <form method="POST" action="{{ route("admin.171klnetwork.corejob.store-restoration.request") }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="requested_by_id" name="requested_by_id" value="{{ \Illuminate\Support\Facades\Auth::user()->id }}">
                            <input type="hidden" id="request_type_id" name="request_type_id" value="{{ config('global.RESTORATION_REQUEST') }}">
...
@section('scripts')
    ...
    <script>
        ...
        function validatePhoneNumber(){
            ...
            var request_type_id = "<?php echo config('global.RESTORATION_REQUEST'); ?>";
