            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST"
                              action="{{ route("admin.171klnetwork.corejob.store-temporary-disconnection.request") }}"
                              enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="requested_by_id" name="requested_by_id"
                                   value="{{ \Illuminate\Support\Facades\Auth::user()->id }}">
                            <input type="hidden" id="request_type_id" name="request_type_id"
                                   value="{{ config('global.TEMPORARY_DISCONNECTION_REQUEST') }}">
...
@section('scripts')
    ...
    <script>
        ...
        function validatePhoneNumber(){
            ...
            var request_type_id = "<?php echo config('global.TEMPORARY_DISCONNECTION_REQUEST'); ?>";
