    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{"Permanently Closing Request"}}</h4>
            </div>
            <div class="modal-body">
                <div class='row'>
                    <div class='col-md-12'>
                        <label for="csv_file" class="col-md-12 control-label">{{"Upload CSV file"}}</label><br>
                                ...
                                <div class="col-md-6 col-md-offset-4">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input type="hidden" id ="jobRequestType" name="jobRequestType" value="{{ config('global.PERMANENT_CLOSE_REQUEST') }}" />
