    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{"Restoration Request"}}</h4>
            </div>
                                ...
                                <div class="col-md-6 col-md-offset-4">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input type="hidden" id ="jobRequestType" name="jobRequestType" value="{{ config('global.RESTORATION_REQUEST') }}" />
