                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.job-requests.update", [$jobRequest->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="number" id="number" value="{{ old('number', $jobRequest->number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('agw_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="agw_ip" id="agw_ip" value="{{ old('agw_ip', $jobRequest->agw_ip) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tid') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tid" id="tid" value="{{ old('tid', $jobRequest->tid) }}" required>
                            @if($errors->has('tid'))
                        ...
                        <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="note" id="note">{!! old('note', $jobRequest->note) !!}</textarea>
                            @if($errors->has('note'))
                        ...
                        <div class="form-group {{ $errors->has('call_source_code') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="call_source_code_id" id="call_source_code_id" required>
                                @foreach($call_source_codes as $id => $call_source_code)
                                    <option value="{{ $id }}" {{ (old('call_source_code_id') ? old('call_source_code_id') : $jobRequest->call_source_code->id ?? '') == $id ? 'selected' : '' }}>{{ $call_source_code }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('request_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="request_time" id="request_time" value="{{ old('request_time', $jobRequest->request_time) }}">
                        ...
                        <div class="form-group {{ $errors->has('verification_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="verification_time" id="verification_time" value="{{ old('verification_time', $jobRequest->verification_time) }}">
                        ...
                        <div class="form-group {{ $errors->has('approval_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="approval_time" id="approval_time" value="{{ old('approval_time', $jobRequest->approval_time) }}">
                        ...
                        <div class="form-group {{ $errors->has('approval_note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="approval_note" id="approval_note">{!! old('approval_note', $jobRequest->approval_note) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('rejection_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="rejection_time" id="rejection_time" value="{{ old('rejection_time', $jobRequest->rejection_time) }}">
                        ...
                        <div class="form-group {{ $errors->has('rejection_note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="rejection_note" id="rejection_note">{!! old('rejection_note', $jobRequest->rejection_note) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('script') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="script" id="script">{{ old('script', $jobRequest->script) }}</textarea>
