                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.olt-job-requests.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('interface') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="interface" id="interface" value="{{ old('interface', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('device_ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="device_ip" id="device_ip" value="{{ old('device_ip', '') }}">
