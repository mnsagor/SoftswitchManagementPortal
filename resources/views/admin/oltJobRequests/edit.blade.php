    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.olt-job-requests.update", [$oltJobRequest->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('olt_ip') ? 'is-invalid' : '' }}" name="olt_ip_id" id="olt_ip_id" required>
                ...
                @if($errors->has('olt_ip'))
                    <span class="text-danger">{{ $errors->first('olt_ip') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="text" name="number" id="number" value="{{ old('number', $oltJobRequest->number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interface') ? 'is-invalid' : '' }}" type="text" name="interface" id="interface" value="{{ old('interface', $oltJobRequest->interface) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('port_number') ? 'is-invalid' : '' }}" type="text" name="port_number" id="port_number" value="{{ old('port_number', $oltJobRequest->port_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('device_ip') ? 'is-invalid' : '' }}" type="text" name="device_ip" id="device_ip" value="{{ old('device_ip', $oltJobRequest->device_ip) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{!! old('note', $oltJobRequest->note) !!}</textarea>
                @if($errors->has('note'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('request_time') ? 'is-invalid' : '' }}" type="text" name="request_time" id="request_time" value="{{ old('request_time', $oltJobRequest->request_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('verification_time') ? 'is-invalid' : '' }}" type="text" name="verification_time" id="verification_time" value="{{ old('verification_time', $oltJobRequest->verification_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('approval_time') ? 'is-invalid' : '' }}" type="text" name="approval_time" id="approval_time" value="{{ old('approval_time', $oltJobRequest->approval_time) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('approval_note') ? 'is-invalid' : '' }}" name="approval_note" id="approval_note">{!! old('approval_note', $oltJobRequest->approval_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('rejection_time') ? 'is-invalid' : '' }}" type="text" name="rejection_time" id="rejection_time" value="{{ old('rejection_time', $oltJobRequest->rejection_time) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('rejection_note') ? 'is-invalid' : '' }}" name="rejection_note" id="rejection_note">{!! old('rejection_note', $oltJobRequest->rejection_note) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('script') ? 'is-invalid' : '' }}" name="script" id="script">{{ old('script', $oltJobRequest->script) }}</textarea>
