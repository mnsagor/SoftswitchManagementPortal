                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.olts.update", [$olt->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $olt->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ip" id="ip" value="{{ old('ip', $olt->ip) }}" required>
                            @if($errors->has('ip'))
                        ...
                        <div class="form-group {{ $errors->has('vlan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="vlan" id="vlan" value="{{ old('vlan', $olt->vlan) }}" required>
                            @if($errors->has('vlan'))
