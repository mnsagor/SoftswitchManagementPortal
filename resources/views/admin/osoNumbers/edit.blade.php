                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.oso-numbers.update", [$osoNumber->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="number" id="number" value="{{ old('number', $osoNumber->number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tid') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tid" id="tid" value="{{ old('tid', $osoNumber->tid) }}" required>
                            @if($errors->has('tid'))
