                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tndp-ims-agws.update", [$tndpImsAgw->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ip" id="ip" value="{{ old('ip', $tndpImsAgw->ip) }}" required>
                            @if($errors->has('ip'))
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $tndpImsAgw->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('is_active') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\TndpImsAgw::IS_ACTIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $tndpImsAgw->is_active) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $tndpImsAgw->description) !!}</textarea>
