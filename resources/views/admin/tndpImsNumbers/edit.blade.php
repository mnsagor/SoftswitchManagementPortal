    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tndp-ims-numbers.update", [$tndpImsNumber->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="text" name="number" id="number" value="{{ old('number', $tndpImsNumber->number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tid') ? 'is-invalid' : '' }}" type="text" name="tid" id="tid" value="{{ old('tid', $tndpImsNumber->tid) }}" required>
                @if($errors->has('tid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agw_ip') ? 'is-invalid' : '' }}" type="text" name="agw_ip" id="agw_ip" value="{{ old('agw_ip', $tndpImsNumber->agw_ip) }}" required>
