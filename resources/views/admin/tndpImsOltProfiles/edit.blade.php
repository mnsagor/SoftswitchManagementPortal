                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tndp-ims-olt-profiles.update", [$tndpImsOltProfile->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $tndpImsOltProfile->date) }}" required>
                            @if($errors->has('date'))
                        ...
                        <div class="form-group {{ $errors->has('serial_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $tndpImsOltProfile->serial_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('interface') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="interface" id="interface" value="{{ old('interface', $tndpImsOltProfile->interface) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('ip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ip" id="ip" value="{{ old('ip', $tndpImsOltProfile->ip) }}" required>
                            @if($errors->has('ip'))
                        ...
                        <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="number" id="number" value="{{ old('number', $tndpImsOltProfile->number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('port_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="port_number" id="port_number" value="{{ old('port_number', $tndpImsOltProfile->port_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $tndpImsOltProfile->description) !!}</textarea>
