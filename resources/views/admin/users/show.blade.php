...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#requested_by_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.jobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#verified_by_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.jobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#approved_by_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.jobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#rejected_by_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.jobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#requested_by_olt_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.oltJobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#verified_by_olt_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.oltJobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#approved_by_olt_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.oltJobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#rejected_by_olt_job_requests" role="tab" data-toggle="tab">
                {{ trans('cruds.oltJobRequest.title') }}
            </a>
        </li>
        <li class="nav-item">
